...
`,(class t extends HTMLElement{#p=null;#r=null;#w=null;#s=void 0;#t=null;#k;static customAnimations;#e="api";constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(G.content.cloneNode(!0))}static get observedAttributes(){return["open","duration","close-label"]}attributeChangedCallback(t,e,o){if(!(!this.isConnected||e===o))switch(t){case"open":this.#A();break;case"duration":this.#i(),this.#h()&&this.#o();break;case"close-label":this.#m()}}get closable(){return this.hasAttribute("closable")}set closable(t){this.toggleAttribute("closable",!!t)}get open(){return this.hasAttribute("open")}set open(t){this.toggleAttribute("open",!!t)}get duration(){let t=this.getAttribute("duration");if(null===t)return 1/0;let e=Number(t);return Number.isNaN(e)?1/0:e}set duration(t){this.setAttribute("duration",null!=t?t.toString():t)}get variant(){return this.getAttribute("variant")||""}set variant(t){this.setAttribute("variant",t)}get closeLabel(){return this.getAttribute("close-label")||"Close"}set closeLabel(t){this.setAttribute("close-label",null!=t?t.toString():t)}get customAnimations(){return this.#k}set customAnimations(t){this.#k=t}connectedCallback(){this.#E("closable"),this.#E("open"),this.#E("duration"),this.#E("variant"),this.#E("closeLabel"),this.#E("customAnimations"),this.#p=this.shadowRoot?.querySelector(".alert")??null,this.#r=this.shadowRoot?.querySelector(".alert__close")??null,this.#w=this.shadowRoot?.querySelector('slot[name="close"]')??null,this.#r?.addEventListener("click",this.#d),this.#w?.addEventListener("slotchange",this.#u),this.addEventListener("mouseenter",this.#l),this.addEventListener("mouseleave",this.#n),this.addEventListener("command",this.#v),this.open?(this.#p?.removeAttribute("hidden"),this.#h()&&this.#o()):this.#p?.setAttribute("hidden",""),this.closeLabel&&this.#m()}disconnectedCallback(){this.#i(),this.#r?.removeEventListener("click",this.#d),this.#w?.removeEventListener("slotchange",this.#u),this.removeEventListener("mouseenter",this.#l),this.removeEventListener("mouseleave",this.#n),this.removeEventListener("command",this.#v)}#A(){this.#i(),this.open?(this.#h()&&this.#o(),this.#p?.removeAttribute("hidden"),this.#c("alert-show"),this.#y(this.#p)?.finished.finally(()=>{this.#c(F)})):(this.#c("alert-hide",{reason:this.#e}),this.#b(this.#p)?.finished.finally(()=>{this.#p?.setAttribute("hidden",""),this.#c(V,{reason:this.#e}),this.#e="api"}))}#i(){void 0!==this.#s&&(clearTimeout(this.#s),this.#s=void 0)}#o(){this.#s=window.setTimeout(()=>{this.#e="timeout",this.open=!1},this.duration)}#h(){return this.open&&this.duration!==1/0}#d=()=>{this.closable&&(this.#e="user",this.open=!1)};#l=()=>{this.#i()};#n=()=>{this.#i(),this.#h()&&this.#o()};#u=()=>{this.#m()};#v=t=>{switch(t.command){case"--alert-show":this.open=!0;break;case"--alert-hide":this.#e="api",this.open=!1}};#m(){this.#r&&((this.#w?.assignedElements()||[])?.some(t=>t.textContent?.replace(/\s/g,"")!=="")?this.#r.removeAttribute("aria-label"):this.#r.setAttribute("aria-label",this.closeLabel))}#x(){let e=window.matchMedia("(prefers-reduced-motion: reduce)").matches,o={show:{keyframes:[{opacity:0,transform:"scale(0.9)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}},hide:{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.9)"}],options:{duration:250,easing:"ease"}}},i=this.customAnimations||t.customAnimations||{},r=r=>{let s=i[r]?.options??{},a=o[r].options;return{...a,...s,duration:e||null===this.customAnimations||null===t.customAnimations?0:s.duration??a.duration}};return{show:{keyframes:i.show?.keyframes??o.show.keyframes,options:r("show")},hide:{keyframes:i.hide?.keyframes??o.hide.keyframes,options:r("hide")}}}#y(t){let{keyframes:e,options:o}=this.#x().show;return t?.animate(e,o)}#b(t){let{keyframes:e,options:o}=this.#x().hide;return t?.animate(e,o)}#c(t,e=null){let o=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});this.dispatchEvent(o)}#a(t,e){return new Promise(o=>{t.addEventListener(e,e=>{e.target===t&&o()},{once:!0})})}show(){return this.open?Promise.resolve():(this.open=!0,this.#a(this,F))}hide(){return this.open?(this.open=!1,this.#a(this,V)):Promise.resolve()}toast(t={}){if(t={forceRestart:!1,...t},this.#t){if(!t.forceRestart)return this.#t.promise;this.#t.resolve(),this.#t.cleanup()}let e=()=>{},o=new Promise(t=>e=t),i=()=>{this.#t?.resolve(),this.#t?.cleanup()};this.#t={promise:o,resolve:e,cleanup:()=>{this.removeEventListener(V,i),this.parentNode===U&&U.removeChild(this),U.querySelector(j)||U.remove(),this.open=!1,this.#t=null}},U.parentElement||document.body.append(U),U.appendChild(this),this.#p?.setAttribute("data-toast",""),this.open=!0;let r=U.shadowRoot?.querySelector(".stack");return r?.scrollTo({top:r.scrollHeight}),this.addEventListener(V,i,{once:!0}),o}#E(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(e=j){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}}).defineCustomElement();const Z=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"],Y="https://api.upcdatabase.org";function J(t){return new Promise(function(e,o){t.oncomplete=t.onsuccess=function(){return e(t.result)},t.onabort=t.onerror=function(){return o(t.error)}})}function K(){var t,e,o,r;return i||(t="keyval-store",e="keyval",r=function(){if(o)return o;var i=indexedDB.open(t);return i.onupgradeneeded=function(){return i.result.createObjectStore(e)},(o=J(i)).then(function(t){t.onclose=function(){return o=void 0}},function(){}),o},i=function(t,o){return r().then(function(i){return o(i.transaction(e,t).objectStore(e))})}),i}const X="barcode-scanner/",Q="settings",tt="history",te=async t=>{try{return[null,await function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:K();return e("readonly",function(e){return J(e.get(t))})}(t)]}catch(t){return[t,void 0]}},to=async(t,e)=>{try{return await function(t,e){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:K();return o("readwrite",function(o){return o.put(e,t),J(o.transaction)})}(t,e),[null]}catch(t){return[t]}},ti=async()=>te(X+Q),tr=async t=>to(X+Q,t),ts=async()=>te(X+tt),ta=async t=>to(X+tt,t);function tn(t,e=0,o=!1){let i=null;if("function"!=typeof t)throw TypeError("Expected a function for first argument");return(...r)=>{clearTimeout(i),o&&!i&&t(...r),i=setTimeout(()=>{i=null,o||t(...r)},e)}}const tl={info:(...t)=>{},error:(...t)=>{},warn:(...t)=>{}};async function td(t,e){if(!t||!e)return;let o=t.querySelector(`bs-result[value="${e}"]`);o&&o.remove();let i=document.createElement("bs-result");i.setAttribute("value",e),i.setAttribute("role","alert"),i.setAttribute("aria-live","assertive"),i.setAttribute("aria-atomic","true"),t.insertBefore(i,t.firstElementChild),t.scrollTop=0}const tc=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return e=>{let{duration:o,frequency:i,volume:r,type:s,onEnded:a}=e,n=t.createOscillator(),l=t.createGain();n.connect(l),l.connect(t.destination),r&&(l.gain.value=r),i&&(n.frequency.value=i),s&&(n.type=s),"function"==typeof a&&(n.onended=a),n.start(t.currentTime),n.stop(t.currentTime+(o||500)/1e3)}})();async function th(t=0){if("function"==typeof window.navigator.vibrate)try{window.navigator.vibrate(t)}catch{}}let tu=0;async function tm(t={}){let{success:e=!0}=t,[,o]=await ti();if(!o)return;let i=Date.now();i-tu<1e3||(o.beep&&tc(e?{duration:200,frequency:860,volume:.03,type:"square"}:{duration:300,frequency:200,volume:.05,type:"sawtooth"}),o.vibrate&&th(e?100:200),tu=i)}function tp(t,e){if(!t||!e)return;let o=t.getBoundingClientRect();e.style.cssText=`width: ${o.width}px; height: ${o.height}px`}const tb=["aztec","code_128","code_39","code_93","codabar","data_matrix","ean_13","ean_8","itf","pdf417","qr_code","upc_a","upc_e"];class tg{static async polyfill(){if("BarcodeDetector"in window)tl.info("Using the native BarcodeDetector API.");else try{await n("3jPiW"),tl.info("Using BarcodeDetector polyfill.")}catch(t){throw Error("BarcodeDetector API is not supported by your browser.",{cause:t})}}static async getSupportedFormats(){let t=await window.BarcodeDetector.getSupportedFormats()||[];return tb.filter(e=>t.includes(e))}static async create(t){let e=Array.isArray(t)&&t.length>0?t:await tg.getSupportedFormats();return new tg(e)}static async setup(){try{return await tg.polyfill(),{barcodeReaderError:null}}catch(t){return{barcodeReaderError:t}}}constructor(t){this.barcodeReader=new window.BarcodeDetector({formats:t})}async detect(t){if(!this.barcodeReader)throw Error("BarcodeReader is not initialized.");let e=await this.barcodeReader.detect(t);if(Array.isArray(e)&&e.length>0){let t=e[0];return tl.info({rawValue:t.rawValue,format:t.format}),t}throw Error("Could not detect barcode from provided source.")}}const tv=t=>t.replace(/\/+$/,"");async function tf(t){if(!t||!/^[0-9]{12,14}$/.test(t))return null;if(!Y)return tl.info("Item info API URL not configured; skipping lookup."),null;let e=tv(Y),o={};async function i(t,e={}){try{let i=await fetch(t,{headers:o,...e});if(!i.ok)return{status:i.status,json:null};try{let t=await i.json();return{status:i.status,json:t}}catch(t){return tl.warn("Non-JSON response from item API",t),{status:i.status,json:null}}}catch(t){return tl.warn("Request failed",t),{status:0,json:null}}}let r=`${e}/product/${encodeURIComponent(t)}`,s=await i(r,{method:"GET"});if(s.json)return s.json;let a=`${e}/products/${encodeURIComponent(t)}`,n=await i(a,{method:"GET"});if(n.json)return n.json;let l=await i(a,{method:"POST"});return l.json?l.json:null}function ty(t={}){let{el:e,isTorchOn:o}={...{el:document.getElementById("torchButton"),isTorchOn:!1},...t},i=e.querySelectorAll("svg path");2===i.length&&(i[0].style.display=o?"none":"block",i[1].style.display=o?"block":"none",e.setAttribute("aria-label",`Turn ${o?"off":"on"} flash`))}function tw(t,e={}){e={duration:5e3,variant:"neutral",icon:"",...e};let o={info:`
    ...
    `}[e.icon||e.variant]||"";return Object.assign(document.createElement("alert-element"),{closable:!0,duration:e.duration,variant:e.variant,innerHTML:`${o?`<span slot="icon">${o}</span>`:""}${e.trustDangerousInnerHTML?t:function(t){let e=document.createElement("div");return e.textContent=t,e.innerHTML}(t)}`}).toast()}const tE="video-capture",tA=`
...
`;class tH extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tO.content.cloneNode(!0))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}static get observedAttributes(){return["value"]}attributeChangedCallback(t,e,o){"value"===t&&e!==o&&this.#R(this.value)}connectedCallback(){if(this.#z("value"),window.matchMedia("(prefers-reduced-motion: no-preference)").matches){let t=this.shadowRoot.querySelector(".result");t?.animate([{backgroundColor:"var(--color-flash)"},{backgroundColor:"transparent"}],{duration:400,easing:"ease-out"})}if(!tM()){let t=this.shadowRoot.querySelector("web-share");t&&(t.hidden=!0)}}async #R(t){let e,o=this.shadowRoot.querySelector(".result"),i=o?.querySelector(".result__content"),r=o?.querySelector(".result__datetime"),s=o?.querySelector(".result__item");s&&s?.remove();try{let[,o]=await ti();new URL(t),(e=document.createElement("a")).href=t,o?.openWebPageSameTab||(e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")),o?.openWebPage?e.click():window.requestAnimationFrame(()=>e.focus())}catch{e=document.createElement("span")}e.className="result__item",e.part="result__item",e.textContent=t,r.textContent=tq.format(new Date),i?.insertBefore(e,r);let a=o?.querySelector("custom-clipboard-copy"),n=o?.querySelector("web-share");if(a){let e=a.shadowRoot?.querySelector("button");a.setAttribute("value",t),e?.setAttribute("aria-label",`Copy to clipboard ${t}`),a.hidden=!1}if(n&&tM()){let e=n.querySelector("button");n.setAttribute("share-text",t),n.hidden=!1,e?.setAttribute("aria-label",`Share ${t}`)}}#z(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-result"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tH)}}tH.defineCustomElement();class tB extends HTMLElement{#M=null;#q=null;#N=[];#O;constructor(){super()}get supportedFormats(){return this.#N}set supportedFormats(t){this.#N=t,this.#H()}async connectedCallback(){this.#z("supportedFormats"),this.#M=this.querySelector("#formatsList"),this.#q=this.querySelector("form");let[,t]=await ti();this.#O=t??{},this.#q?.querySelectorAll('[name="general-settings"]').forEach(t=>{t.checked=this.#O[t.value]})}#H(){if(!this.#M)return;let t=this.#O?.formats;this.#M.replaceChildren(),this.supportedFormats.forEach(e=>{let o=document.createElement("li"),i=document.createElement("label"),r=document.createElement("input");r.type="checkbox",r.name="formats-settings",r.value=e,r.checked=null==t||t.includes(e),i.appendChild(r),i.appendChild(document.createTextNode(e)),o.appendChild(i),this.#M.appendChild(o)})}#z(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-settings"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tB)}}tB.defineCustomElement();const t$=`
  :host {
...
`;class tD extends HTMLElement{#B=null;#$=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tI.content.cloneNode(!0))}async connectedCallback(){this.#B=this.shadowRoot?.getElementById("historyList"),this.#$=this.shadowRoot?.getElementById("emptyHistoryBtn"),this.#I((await ts())[1]||[]),this.#B?.addEventListener("click",this.#D),this.#$?.addEventListener("click",this.#P)}disconnectedCallback(){this.#B?.removeEventListener("click",this.#D),this.#$?.removeEventListener("click",this.#P)}async add(t){if(!t)return;let e={type:"add",message:"Error adding barcode to history"},[o,i=[]]=await ts();if(o||!Array.isArray(i))return this.#j("bs-history-error",e),o;if(i.find(e=>e===t))return;let r=[...i,t],[s]=await ta(r);return s?(tl.error("Error setting history",s),this.#j("bs-history-error",e),s):(this.#B?.insertBefore(this.#F(t),this.#B.firstElementChild),this.#j("bs-history-success",{type:"add",message:"Barcode added to history"}),null)}async remove(t){if(!t)return;let e={type:"remove",message:"Error removing barcode from history"},[o,i=[]]=await ts();if(o||!Array.isArray(i))return this.#j("bs-history-error",e),o;let r=i.filter(e=>e!==t),[s]=await ta(r);if(s)return tl.error("Error setting history",s),this.#j("bs-history-error",e),s;let a=this.#B?.querySelector(`li[data-value="${t}"]`);return a?.remove(),this.#j("bs-history-success",{type:"remove",message:"Barcode removed from history"}),null}async empty(){let[t]=await ta([]);return t?(tl.error("Error setting history",t),this.#j("bs-history-error",{type:"empty",message:"Error emptying history"}),t):(this.#B?.replaceChildren(),this.#j("bs-history-success",{type:"empty",message:"History emptied successfully"}),null)}#I(t){if(!this.#B)return;this.#B.replaceChildren();let e=document.createDocumentFragment();[...t].reverse().forEach(t=>e.appendChild(this.#F(t))),this.#B.appendChild(e)}#F(t){let e,o=document.createElement("li");o.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch{e=document.createElement("span")}e.textContent=t;let i=document.createElement("div");i.className="actions";let r=document.createElement("custom-clipboard-copy"),s=r.shadowRoot?.querySelector("button");r.setAttribute("only-icon",""),r.setAttribute("value",t),s?.setAttribute("aria-label",`Copy to clipboard ${t}`),i.appendChild(r);let a=document.createElement("button");return a.type="button",a.className="delete-action",a.setAttribute("data-action","delete"),a.setAttribute("aria-label",`Remove from history ${t}`),a.innerHTML=`
    ...
    `,i.appendChild(a),o.appendChild(e),o.appendChild(i),o}#D=async t=>{let e=t.target;if(e.closest('[data-action="delete"]')){let t=e.closest("li").dataset.value;window.confirm(`Delete history item ${t}?`)&&this.remove(t)}};#P=async()=>{window.confirm("Empty history? This action cannot be undone.")&&this.empty()};#j(t,e=null){let o=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});this.dispatchEvent(o)}static defineCustomElement(t="bs-history"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tD)}}tD.defineCustomElement(),async function(){let t=document.querySelector("a-tab-group"),e=document.querySelector("video-capture"),o=document.querySelector("bs-settings"),i=document.querySelector("bs-history"),r=document.getElementById("cameraPanel"),s=r.querySelector(".results"),a=document.getElementById("filePanel"),n=a.querySelector(".results"),l=document.getElementById("scanInstructions"),d=document.getElementById("scanBtn"),c=document.getElementById("dropzone"),h=document.querySelector("resize-observer"),u=document.getElementById("scanFrame"),m=document.getElementById("torchButton"),p=document.getElementById("globalActions"),b=document.getElementById("historyBtn"),g=document.getElementById("historyDialog"),v=document.getElementById("settingsBtn"),f=document.getElementById("settingsDialog"),y=document.getElementById("settingsForm"),w=document.getElementById("cameraSelect"),E=null,A=!0;"function"==typeof HTMLDialogElement&&(p?.removeAttribute("hidden"),g?.removeAttribute("hidden"),f?.removeAttribute("hidden"));let{barcodeReaderError:x}=await tg.setup();if(x){let e=document.getElementById("barcodeReaderError");A=!1,p?.setAttribute("hidden",""),t?.setAttribute("hidden",""),e?.setAttribute("open","");return}let k=await tg.getSupportedFormats(),[,C]=await ti(),L=C?.formats||k,_=await tg.create(L);async function S(t,e){try{let o=await tf(t);if(o){let i=o.title||o.name||o.alias||"",r=o.description||o.brand||"",s=`${i||t}${r?` \u{2014} ${r}`:""}`;tw(s,{variant:"success"}),function(t,e){if(!t||!e)return;let o=t.querySelector("#itemInfo");if(!o){(o=document.createElement("div")).id="itemInfo",o.className="item-info";let e=t.querySelector(".results");e&&e.parentNode?e.parentNode.insertBefore(o,e.nextSibling):t.appendChild(o)}o.textContent="";let i=document.createElement("h3");i.className="item-info__title",i.textContent=e.title||e.name||e.alias||"";let r=document.createElement("p");r.className="item-info__description",r.textContent=e.description||"";let s=document.createElement("p");s.className="item-info__brand",s.textContent=e.brand?`Brand: ${e.brand}`:"",o.appendChild(i),r.textContent&&o.appendChild(r),s.textContent&&o.appendChild(s)}(e,o)}}catch(t){}}e.addEventListener("video-capture:video-play",N,{once:!0}),e.addEventListener("video-capture:error",function(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let o="NotAllowedError"===e.name?"<strong>Error accessing camera</strong><br>Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;r.innerHTML=`
    ...
    `},{once:!0}),tk.defineCustomElement();let z=e?.shadowRoot,T=z?.querySelector("video"),R=z?.querySelector('[part="actions-container"]');async function M(){if(A){tl.info("Scanning..."),l?.removeAttribute("hidden");try{let[,t]=await ti(),e=await _.detect(T),o=e?.rawValue??"";if(!o)throw Error("No barcode detected");if(td(s,o),S(o,r),t?.addToHistory&&i?.add(o),tm(),!t?.continueScanning){E&&(clearTimeout(E),E=null),d?.removeAttribute("hidden"),u?.setAttribute("hidden",""),R?.setAttribute("hidden","");return}}catch{}A&&(E=setTimeout(()=>M(),1e3))}}async function q(t){if(!t)return;let[,e]=await ti(),o=new Image,r=new FileReader;r.onload=r=>{let s=r.target.result;o.onload=async()=>{try{let t=await _.detect(o),r=t?.rawValue??"";if(!r)throw Error("No barcode detected");td(n,r),S(r,a),e?.addToHistory&&i?.add(r),tm()}catch(t){tl.error(t),tw("<strong>No barcode detected</strong><br><small>Please try again with a different image.</small>",{variant:"danger",trustDangerousInnerHTML:!0}),tm({success:!1})}},o.src=s,o.alt="Image preview",c.replaceChildren();let l=document.createElement("div");l.className="dropzone-preview";let d=document.createElement("div");d.className="dropzone-preview__image-wrapper";let h=document.createElement("div");h.className="dropzone-preview__file-name",h.textContent=t.name,d.appendChild(o),l.appendChild(d),l.appendChild(h),c.prepend(l)},r.readAsDataURL(t)}async function N(t){u?.removeAttribute("hidden"),tp(t.detail.video,u),M();let o=t.target.getTrackSettings(),i=t.target.getTrackCapabilities(),r=document.getElementById("zoomLevel");if(i?.torch&&(m?.addEventListener("click",H),m?.removeAttribute("hidden"),e.hasAttribute("torch")&&ty({el:m,isTorchOn:!0})),o?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),s=i?.zoom?.min||0,a=i?.zoom?.max||10,n=o?.zoom||1;t?.addEventListener("click",t=>{let o=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');o&&n<a&&(n+=.5),i&&n>s&&(n-=.5),r.textContent=n.toFixed(1),e.zoom=n}),t?.removeAttribute("hidden"),r.textContent=n.toFixed(1)}let s=await tk.getVideoInputDevices();s.forEach((t,e)=>{let o=document.createElement("option");o.value=t.deviceId,o.textContent=t.label||`Camera ${e+1}`,w.appendChild(o)}),s.length>1&&(w?.addEventListener("change",B),w?.removeAttribute("hidden"))}async function O(t){t.preventDefault();let e={},o=new FormData(y),i=o.getAll("general-settings"),r=o.getAll("formats-settings");i.forEach(t=>e[t]=!0),e.formats=r,tr(e),"formats-settings"===t.target.name&&(_=await tg.create(r))}function H(t){e.torch=!e.torch,ty({el:t.currentTarget,isTorchOn:e.hasAttribute("torch")})}function B(t){if("function"!=typeof e.restartVideoStream)return;let o=t.target.value||void 0;e.restartVideoStream(o)}c.accept=Z.join(","),o.supportedFormats=k,d.addEventListener("click",function(){d?.setAttribute("hidden",""),u?.removeAttribute("hidden"),R?.removeAttribute("hidden"),M()}),t.addEventListener("a-tab-show",tn(function(t){let e=t.detail.tabId,o=document.querySelector("video-capture");if("cameraTab"===e){if(A=!0,!o)return;if(!o.loading&&d.hasAttribute("hidden")&&(u?.removeAttribute("hidden"),R?.removeAttribute("hidden"),M()),"function"==typeof o.startVideoStream){let t=w?.value||void 0;o.startVideoStream(t)}}else"fileTab"===e&&(A=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream(),u?.setAttribute("hidden",""),R?.setAttribute("hidden",""))},250)),c.addEventListener("files-dropzone-drop",function(t){q(t.detail.acceptedFiles[0])}),h.addEventListener("resize-observer:resize",function(){tp(e.shadowRoot.querySelector("video"),u)}),v.addEventListener("click",function(){f.open=!0}),y.addEventListener("change",tn(O,500)),b.addEventListener("click",function(){g.open=!0}),document.addEventListener("visibilitychange",function(){if("cameraTab"===t.querySelector("[selected]").getAttribute("id"))if("hidden"===document.visibilityState)A=!1,null!=e&&"function"==typeof e.stopVideoStream&&e.stopVideoStream();else{A=!0;let t=document.querySelector("video-capture");if(!t)return;if(!t.loading&&d.hasAttribute("hidden")&&M(),"function"==typeof t.startVideoStream){let e=w?.value||void 0;t.startVideoStream(e)}}}),document.addEventListener("keydown",function(e){"Escape"===e.key&&function(){let e=t.querySelector("#cameraTab").hasAttribute("selected"),o=!d.hidden,i=f.hasAttribute("open"),r=g.hasAttribute("open");o&&e&&!(i||r)&&d.click()}()}),document.addEventListener("bs-history-success",function(t){let{type:e,message:o}=t.detail;"add"===e&&tw(o,{variant:"success"})}),document.addEventListener("bs-history-error",function(t){let{type:e,message:o}=t.detail;("remove"===e||"empty"===e)&&g?.hide(),tw(o,{variant:"danger"})})}();
//# sourceMappingURL=barcode-scanner-CS465.c0d06ad2.js.map
